...
// Fixed reference point shared by every group below: July 24, 2026, 10:00 AM PST (5:00 PM UTC).
// Kept at module scope so the sibling describes stay small enough for max-lines-per-function
// without duplicating the clock.
const NOW = new Date("2026-07-24T17:00:00Z");

describe("describeEtaCountdown - overdue (delta < 0)", () => {
...
describe("describeEtaCountdown - due today (delta === 0)", () => {
...
describe("describeEtaCountdown - soon (0 < delta <= 6)", () => {
...
describe("describeEtaCountdown - upcoming (7 <= delta <= 27)", () => {
...
describe("describeEtaCountdown - distant (delta >= 28)", () => {
...
describe("describeEtaCountdown - invalid input", () => {
...
describe("describeEtaCountdown - determinism", () => {
...
describe("describeEtaCountdown - PST timezone handling", () => {
