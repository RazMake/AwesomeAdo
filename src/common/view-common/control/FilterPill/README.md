...
enhanced-view filter pills. `appendFilterPillCounts` adds the 14px Queue-column and Active-column
circles used by people filters without making those pills taller than user tags.
